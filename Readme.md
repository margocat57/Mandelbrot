...
В данной работе исследуются различные способы оптимизации одного из вычислительно затратных алгоритмов — построение множества Мандельброта. Внимание в данной работе уделяется как оптимизациям, автоматически выполняемыми компиляторами g++ и clang++, так и ручным преобразованиям кода, направленным на ускорение вычислений за счёт использования SIMD-инструкций.

Если вам интересно самостоятельно собрать проект, то инструкции по сборке представлены [ниже](#Сборка-и-запуск)
